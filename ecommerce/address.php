...
{
  $name=$_GET['name'];
 $query=mysqli_query($con,"select * from personal_details where name='$name' ");
 ...
 if(isset($_POST['submit']))
{
    ...
    $sql= "INSERT INTO `address`(`user_id`,`address`) VALUES ('$id','$address')";
     ...
     if($query==true)
    {
      ...
      ?>
         ...
         <script> 
                  ...
                  window.open('biling.php?id=<?php echo $id ?>','_self');
